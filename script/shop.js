...
const womans = [
    ...
    "description": "<br>Роза однаголовая 15шт, зелень. Клубника в белом шоколаде 7шт, клубника свежая 10шт. <br><br> Заказ 5-7 дней"
  },
  {
    "id": 2,
    ...
    "description": "<br>Цветы: роза одноглавая, роза кустовая, хризантема, зелень. <br><br> Размер 25*25*12 <br><br> Зефир с разными начинками, Рафаэлло, макаронс,  клубника/голубика в шоколаде (по наличию, по сезону) другие сладости. <br><br> Возможно наполнение под запрос. <br><br> Заказ 5-7 дней "
  },
  {
    "id": 3,
    ...
    "description": "<br>Цветы: хризантема (возможно под запрос другие цветы) <br><br> Размер 23*20 <br><br> Королевские финики в белом и молочном шоколаде 10-12шт с начинками: сыр дор Блю, курага, различные виды орехов. <br><br>Заказ 5-7 дней "
  },
  {
    "id": 4,
    ...
    "description": "<br>Цветы: роза однаголовая, роза кустовая, эвкалипт <br><br> Различные виды конфет, макаронс, различные виды орехов в шоколаде, марчмеллоу, сердца граната в белом шоколаде (по сезону, по наличию) <br><br> Возможно наполнение под запрос. <br><br> Заказ 5-7 дней "
  }
];
